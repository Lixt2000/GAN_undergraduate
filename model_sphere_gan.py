...
from keras.layers import GlobalAveragePooling2D, Conv2D, Conv2DTranspose, Input, Dense, Reshape, Flatten, Lambda, Activation
...
def LN(u):
    #u = tf.compat.v1.contrib.layers.layer_norm(u)
    u = LayerNormalization(axis = -1)(u)
    return u
...
def Generator(noise_dim, batch_size, f=512):    
    ...
    for i in range(nb_upconv):
        ...
        x = Conv2DTranspose(nb_filters, (4, 4),
