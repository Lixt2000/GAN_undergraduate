...
class LSGAN():
    def __init__(self):
        ...
        optimizer = Adam(0.0002, beta_1=0.0, beta_2=0.9)
    ...
    def sample_images(self, iteration):
        ...
        if not os.path.exists('cage_images-LSGAN/'):
            os.makedirs('cage_images-LSGAN/')
        fig.savefig("cage_images-LSGAN/cage_%d.png" % iteration)
        plt.close()
