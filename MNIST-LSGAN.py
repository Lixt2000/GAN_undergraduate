...
class LSGAN():
    ...
    def train(self, iterations, batch_size=64, sample_interval=50):
    ...
    def sample_images(self, iteration):
        ...
        if not os.path.exists('mnist_images-LSGAN/'):
            os.makedirs('mnist_images-LSGAN/')
        fig.savefig("mnist_images-LSGAN/mnist_%d.png" % iteration)
        plt.close()
